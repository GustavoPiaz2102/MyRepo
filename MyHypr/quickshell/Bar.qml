...
Scope {
    ...
    component BarContent: Item {
        ...
        Row {
            ...
            // --- SEÇÃO DOS WORKSPACES CORRIGIDA ---
            Row {
                spacing: 3
                anchors.verticalCenter: parent.verticalCenter

                Repeater {
                    // Agora utiliza a integração nativa e dinâmica do Hyprland
                    model: Hyprland.workspaces

                    Item {
                        required property var modelData
                        property var ws: modelData
                        property bool active: Hyprland.focusedWorkspace != null && Hyprland.focusedWorkspace.id === ws.id
                        property bool show: true // Workspaces dinâmicos sempre devem aparecer
                        ...
                        Rectangle {
                            ...
                            Text {
                                id: tagNum
                                anchors.centerIn: parent
                                text: ws.id // Usa o ID do workspace
                        ...
                        MouseArea {
                            ...
                            hoverEnabled: true
                            cursorShape: Qt.PointingHandCursor
                            onClicked: ws.activate() // Ativação nativa, sem depender do comando mmsg
                        }
                    }
                }
            }
